...
public:
	...
	int waiting_time;				//vector containing wait time for each burst
	int turnaround_time;			//vector containing turnaround time for each burst
	int response_time;				//vector containing response time for each burst
...
public:
	...
	void insertInorderName(shared_ptr<listnode>&);
	void insertBack(shared_ptr<listnode>&);
